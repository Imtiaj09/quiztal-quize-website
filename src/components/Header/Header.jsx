  ...
  return (
	...
	<div className="container flex justify-between h-16 mx-auto">
		<Link rel="noopener noreferrer" to="/" aria-label="Back to homepage" className="flex items-center p-2">
			...
			<p className='text-2xl font-bold'>Quizal</p>
		</Link>
		<ul className="items-stretch hidden space-x-3 md:flex">
			...
			<li className="flex">
				<Link rel="noopener noreferrer" to="/topics" className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Topics</Link>
			</li>
			<li className="flex">
				<Link rel="noopener noreferrer" to="/statistics" className="flex items-center px-4 -mb-1 ">Statistics</Link>
			</li>
			<li className="flex">
