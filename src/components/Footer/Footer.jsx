	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<Link rel="noopener noreferrer" to="/" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">Quizal</span>
			</Link>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					...
					<li>
						<Link rel="noopener noreferrer" to="/integrations">Integrations</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" to="/pricing">Pricing</Link>
					</li>
					<li>
			...
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					<li>
						<Link rel="noopener noreferrer" to="/privacy">Privacy</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" to="/terms of service">Terms of Service</Link>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					<li>
						<Link rel="noopener noreferrer" to="/public api">Public API</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" to="/documentation">Documentation</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" to="/guides">Guides</Link>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
